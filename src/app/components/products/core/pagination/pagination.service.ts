...
import { Card } from '../product/card.interface';
@Injectable({
  providedIn: 'root'
})
export class PaginationService {
  ...
  setProductForCurrentPage(products:Card[]){
    this.currentPageProducts = products.slice((this.currentPage - 1)  * this.productsOnPage,this.currentPage*this.productsOnPage)
  }
